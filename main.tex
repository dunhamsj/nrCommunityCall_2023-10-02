      ...
      \column{0.5\textwidth}
        ...
        \begin{itemize}
          ...
          \item
            GR (xCFC)
          \item
            Hydro (Valencia)\footnote{\citet{pbe2021},\citet{ebd2019},\citet{dem2020}}
          \item
            Neutrino transport (M1)\footnote{\citet{lec2021}}
          \item
...
\frametitle{Standing Accretion Shock Instability}
  ...
  Add citation to 2020 paper and to the arxiv preprint
  mention that used thornado to investigate gr on sasi
\footnote{2020 paper}
\footnote{2023 paper}
